...
class SettingsDialog(QDialog):
    def __init__(self, pet):
        ...
        self.pet_settings = _load_json(self.pet_settings_path, {'version': 1, 'behavior': {'move_speed': 1.5, 'ai_interval_ms': 2000, 'auto_walk_enabled': True, 'roam_radius_px': 0, 'edge_margin_px': 0}, 'sleep': {'enabled': True, 'idle_minutes': 20, 'adrenaline_minutes': 10}, 'reminders': {'water_enabled': True, 'water_interval_min': 60, 'move_enabled': True, 'move_interval_min': 90, 'active_start_h': 9, 'active_start_m': 0, 'active_end_h': 23, 'active_end_m': 30, 'notice_duration_ms': 3000}})
    ...
    def _load_into_widgets(self):
        ...
        if hasattr(self, "cb_sleep_enable"):
            ...
            self.sp_sleep_idle_min.setValue(int(slp.get("idle_minutes", 20)))
        ...
        self.sp_water_interval.setValue(int(r.get("water_interval_min", 60)))
        self.cb_move_enable.setChecked(bool(r.get("move_enabled", True)))
        self.sp_move_interval.setValue(int(r.get("move_interval_min", 90)))
    ...
    def _build_ai(self):
        ...
        grid_persona.addWidget(self.ai_auto_screenshot, 1, 1)
        ...
        grid_persona.addWidget(self.cb_app_bubbles_ai, 1, 2, 1, 2)
        ...
        grid_persona.addWidget(self.cb_auto_watch_ai, 2, 2, 1, 2)
